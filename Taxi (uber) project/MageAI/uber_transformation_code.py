...
def transform(df, *args, **kwargs):
    ...
    datetime_dim[['datetime_id', 'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'pickup_hour', 'pickup_day', 'pickup_month', 'pickup_year', 'pickup_weekday',	'dropoff_hour',	'dropoff_day', 'dropoff_month',	'dropoff_year',	'dropoff_weekday']]
    ...
    fact_table = df.merge(passenger_count_dim, on= 'passenger_count') \
            ...
            'dropoff_location_id', 'payment_type_id', 'fare_amount', 
